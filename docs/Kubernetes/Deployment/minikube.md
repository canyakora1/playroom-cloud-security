...
!!! tip "Docker Desktop installation"
...
On your Docker Desktop, you should be able to your deployed Kubernetes cluster under the `Containers` tab. ![docker-k8s](../../assets/images/K8S/docker-k8scluster.png)
