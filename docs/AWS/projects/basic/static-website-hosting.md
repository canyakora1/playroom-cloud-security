...
![aws-static-web](../../../assets/images/AWS/static-aws.png)

Check our our Github page for html code and detailed walkthrough from start to finish

<div class="iframely-embed"><div class="iframely-responsive" style="height: 140px; padding-bottom: 0;"><a href="https://github.com/playroom-security/aws-s3-static-site" data-iframely-url="https://iframely.net/EhXgGS6P?card=small&theme=dark"></a></div></div><script async src="https://iframely.net/embed.js"></script>

## :bucket: How to deploy your static web site on AWS using s3 bucket
